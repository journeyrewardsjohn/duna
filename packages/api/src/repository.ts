    ...
    organization: (organizationId: string) =>
      organizationId === demoOrganization.id
        ? {
            ...
            videoAllowance: {
              baseUploadSeconds: 500 * 60 * 60,
              baseLiveSeconds: 40 * 60 * 60,
              paidUploadSeconds: 0,
              paidLiveSeconds: 0,
              earnedUploadSeconds: 0,
              earnedLiveSeconds: 0,
              grantedUploadSeconds: 0,
              grantedLiveSeconds: 0,
              totalUploadSeconds: 500 * 60 * 60,
              totalLiveSeconds: 40 * 60 * 60,
              payAsYouGo: false,
