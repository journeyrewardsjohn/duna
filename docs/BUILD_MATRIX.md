...
| M13 Messaging                | HQ, Pro, Player               | Connected consent ledger, consent-safe draft composer, native roster SMS handoff, LiveKit session-note transcription, private/shareable review boundary, guardian-copy and quiet-hours rules                  | Draft and native handoff workflows verified; delivery providers and sender approvals pending                                      |
