...
| ---------------------------- | ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| M1 Identity and guardianship | Player, Pro, HQ, Admin        | Connected profile, household, consent, guardian-review, export/deletion flows; WorkOS AuthKit adapter                         | Staging AuthKit live on Web and HQ; production WorkOS promotion remains gated                                          |
