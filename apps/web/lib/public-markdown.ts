...
export const staticPublicPages = [
  ...
  },
  {
    ...
    sections: [
      ...
      "The artifacts shown on the page are illustrative: one drill, one 90-minute Tuesday session containing it, and the eight-week build that session belongs to.",
    ],
  },
  {
    path: "/safety",
